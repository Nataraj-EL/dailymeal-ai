...
export const ingredients: Ingredient[] = [
  ...
  { id: 'coriander_leaves', en: 'Coriander Leaves', ta: 'கொத்தமல்லித்தழை', category: 'vegetables', emoji: '🌿', available: true },
  ...
  { id: 'green_gram', en: 'Green Gram (Whole Moong)', ta: 'பச்சைப்பயறு', category: 'protein', emoji: '🫘', available: true },
  ...
  { id: 'turmeric_powder', en: 'Turmeric Powder', ta: 'மஞ்சள்தூள்', category: 'spices_pantry', emoji: '🟡', available: true },
  { id: 'tamarind', en: 'Tamarind', ta: 'புளி', category: 'spices_pantry', emoji: '🫚', available: true },
  { id: 'sambar_powder', en: 'Sambar Powder', ta: 'சாம்பார்பொடி', category: 'spices_pantry', emoji: '🌶️', available: true },
